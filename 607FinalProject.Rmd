...
## NYT Sentiment Analysis Summary

We created a summary table without the full review text for easier data analysis.
...
<a href="">NYT Sentiment Summary</a>
...
We then analyzed the complete dataset of tweets. For our primary twitter dataset, we combined all seven days of tweets into one dataframe of 5,445 records.
...
We looked at the average Twitter Sentiment by movie. This returned fewer movies than had New York Times reviews. More obscure or independent movies, or movies with limited releases, were less likely to have mentions on Twitter.
...
kable(moviesum1, row.names = TRUE)
...
<a href="">Twitter Sentiment Summary</a>
...
We compared New York Times review sentiment score and Twitter average sentiment score for the top 10 movies. Six of the movies seemed to have a similar score from both sources, while four of the movies did not.
...
We found Slack easy to use with a pleasant user interface and file sharing options. Slack may be more useful for larger groups. For our 3-person group, we found that email was mostly manageable. Since we were already checking in on email, RPubs, and Github, Slack seemed like one more thing to check.
