...
data<-df[,c(3:9)]
data$Sentiment_Score_nyt=round(data$Sentiment_Score_nyt,2)
#data$Sentiment_Score=round(data$Sentiment_Score,2)

datatable(data, options = list(columnDefs = list(list(className = 'dt-center', targets = 5)), pageLength = 5, lengthMenu = c(5, 10, 40)), rownames= TRUE)
```
