...
datanyt$Sentiment_Score_nyt=round(datanyt$Sentiment_Score_nyt,2)
#data$Sentiment_Score=round(data$Sentiment_Score,2)

datatable(datanyt, options = list(columnDefs = list(list(className = 'dt-center', targets = 5)), pageLength = 5, lengthMenu = c(5, 10, 40)), rownames= TRUE)
```
...
datatw<-df[,c(2:4)]
datatw$Sentiment_Score=round(datatw$Sentiment_Score,2)

datatable(datatw, options = list(columnDefs = list(list(className = 'dt-center', targets = 5)), pageLength = 5, lengthMenu = c(5, 10, 40)), rownames= TRUE)
```
...
datatable(datacombo, options = list(columnDefs = list(list(className = 'dt-center', targets = 5)), pageLength = 40, lengthMenu = c(5, 10, 40)), rownames= TRUE)
...
We compared New York Times review sentiment score and Twitter average sentiment score for the top 10 movies by tweet count. Six of the movies seemed to have a similar score from both sources, while four of the movies did not.
