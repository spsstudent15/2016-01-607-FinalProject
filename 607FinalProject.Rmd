...
NYTREVIEWS_JSON_URL1 = 'http://api.nytimes.com/svc/movies/v2/reviews/search.json?opening-date=2016-04-21;2016-05-07&api-key=YOURAPIKEYHERE&order=by-title'#url for api results 0-20
...
NYTREVIEWS_JSON_URL2 = 'http://api.nytimes.com/svc/movies/v2/reviews/search.json?opening-date=2016-04-21;2016-05-07&api-key=YOURAPIKEYHERE&offset=20&order=by-title' #url for api results 20-40
...
Exported to CSV.
```{r, eval=FALSE}
write.table(combo, "20160508nytreviews.csv") 

```

> The resulting CSV is available here:
https://raw.githubusercontent.com/spsstudent15/Data607FinalProject/master/20160508nytreviews.csv


## Part 3. Retrieve New York Times review text for each entry and perform sentiment analysis.
...
We then ran the review text through sentiment analysis with indico, again resulting in a 0-100 score.
...
## Part 4. Peform Twitter Search and Twitter Sentiment Analysis
...
> The resulting CSVs are available here: https://raw.githubusercontent.com/spsstudent15/Data607FinalProject/master/Tweets%20for%2005.03.2016.csv
