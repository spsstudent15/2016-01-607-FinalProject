...
We chose the following cities at random: `r paste(str_trim(locations$City), collapse = ", ")`.
...
# Box Plot of Sentiment Scores by Top Movies

```{r, warning=FALSE, message=FALSE, height=800, width = 600}
library(plotly)
