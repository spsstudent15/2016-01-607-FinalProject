...
The following box plot compares New York Times review sentiment score and Twitter average sentiment score for the top 10 movies. Six of the movies seem to have a similar score from both sources, while four of the movies do not.
...
The following bar plots show average Twitter sentiment score by movie and by city.
...
The following map shows average Twitter sentiment score by movie, for the top 10 movies. Larger circles indicate more positive sentiment. Different colors indicate different movies.
