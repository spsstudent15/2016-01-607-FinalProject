...
We will consider a "good" score any score >= 0,75 and would expect the movie to be tagged with "Critics's Pick" (value = 1).  

We will take a look at Pick/Good (True Positive), Pick/Bad (False Negative), NotPick/Good (False Positive), NotPick/Bad (True Negative)
...
Percentage of False Positive: `r (nrow(nyt_false_positive)/nrow(movie_score_nyt) * 100)  
Percentage of False Negative: `r (nrow(nyt_false_negative)/nrow(movie_score_nyt) * 100)
Percentage of True Positive:  `r (nrow(nyt_true_positive)/nrow(movie_score_nyt) * 100)
Percentage of True Negative:  `r (nrow(nyt_true_negative)/nrow(movie_score_nyt) * 100)   
