...
Twitter free service for directed search limited the number of tweets to the last 5000. We had to revise our approach and coordinate the timing of the NY Times reviews with when we were pulling tweets to have any hope of having relevant data. 
...
The results indicated that the New York Times does not reflect the tweet scores which we used as a proxy indicator of public opinion of the movies. 
